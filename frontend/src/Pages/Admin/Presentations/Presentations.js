...
import { addPresentation, getAllPresentations } from '../../../API/presentationCalls';
...
const Presentations = () => {
  ...
  return <PresentationsView data={data} submitForm={submitForm} movies={movies} halls={halls} />;
};
