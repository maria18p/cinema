...
import { MoviesGrid, MoviesGridImage, MoviesGridItem, MoviesGridItemTitle } from './Movies.style';
        ...
        {props.movies.map((movie, index) => {
          ...
          return (
            <MoviesGridItem key={shortid.generate()}>
              <MoviesGridItemTitle key={shortid.generate()}>{movie.name}</MoviesGridItemTitle>
              <MoviesGridImage
